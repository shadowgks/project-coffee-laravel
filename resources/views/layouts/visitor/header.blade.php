        ...
        <div class="flex flex-wrap justify-between items-center mx-auto md:px-20">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    <li>
                        <a href="{{route('home')}}"
                            class="block py-2 pr-4 pl-3 text-slate-400 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 hover:text-white"
                            aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="{{route('menu')}}"
                            class="block py-2 pr-4 pl-3 text-slate-400 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 hover:text-white">Menu</a>
                    </li>
                </ul>
            </div>
        </div>
