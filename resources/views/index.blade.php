        ...
        <div class="bg-cover bg-center h-screen backdrop-blur" style="background-image: url('./assets/img/slider-bg-coffe-1.jpg')">
            <div class="flex justify-center items-center h-screen text-center">
                <div class="max-w-screen-md">
                    ...
                    <p class="mb-8 font-light text-gray-300 sm:text-xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex placeat perferendis quibusdam quis, autem fugit aspernatur enim provident dolorem a fugiat debitis alias similique totam, eligendi accusamus nisi
                        corporis amet?.</p>
